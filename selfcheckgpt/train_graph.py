...
if __name__ == "__main__":
    ...
    embedder_file = f"embedder_1024_SCGPT_act_ReLU_opt_AdamW_lr_0.0001_bs_256_t_0.07.pt"
    ...
    if args.save_model:
        torch.save(save, path_join(args.output_dir, f"1024_SCGPT_GAT_{best_i}.pt"))